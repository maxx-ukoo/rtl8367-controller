...
static rtk_api_ret_t _rtk_port_macLocalLoopbackEnable_get(rtk_port_t port, rtk_enable_t *pEnable)
{
    ...
    if ((retVal = rtl8367c_getAsicPortLoopback(rtk_switch_port_L2P_get(port), (rtk_uint32*)pEnable)) != RT_ERR_OK)
        return retVal;
...
static rtk_api_ret_t _rtk_port_phyEnableAll_get(rtk_enable_t *pEnable)
{
    ...
    if ((retVal = rtl8367c_getAsicPortEnableAll((rtk_uint32*)pEnable)) != RT_ERR_OK)
        return retVal;
