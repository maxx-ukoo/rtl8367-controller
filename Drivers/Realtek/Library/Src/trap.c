...
static rtk_api_ret_t _rtk_trap_unknownUnicastPktAction_get(rtk_port_t port, rtk_trap_ucast_action_t *pUcast_action)
{
    ...
    if ((retVal = rtl8367c_getAsicPortUnknownDaBehavior(rtk_switch_port_L2P_get(port), (rtk_uint32*)pUcast_action)) != RT_ERR_OK)
        return retVal;
...
static rtk_api_ret_t _rtk_trap_unknownMacPktAction_get(rtk_trap_ucast_action_t *pUcast_action)
{
    ...
    if ((retVal = rtl8367c_getAsicPortUnknownSaBehavior((rtk_uint32*)pUcast_action)) != RT_ERR_OK)
        return retVal;
...
static rtk_api_ret_t _rtk_trap_unmatchMacPktAction_get(rtk_trap_ucast_action_t *pUcast_action)
{
    ...
    if ((retVal = rtl8367c_getAsicPortUnmatchedSaBehavior((rtk_uint32*)pUcast_action)) != RT_ERR_OK)
        return retVal;
...
static rtk_api_ret_t _rtk_trap_unmatchMacMoving_get(rtk_port_t port, rtk_enable_t *pEnable)
{
    ...
    if ((retVal = rtl8367c_getAsicPortUnmatchedSaMoving(rtk_switch_port_L2P_get(port), (rtk_uint32*)pEnable)) != RT_ERR_OK)
        return retVal;
...
static rtk_api_ret_t _rtk_trap_lldpEnable_set(rtk_enable_t enabled)
{
    ...
    if ((retVal = rtl8367c_getAsicRmaLldp((rtk_uint32*)&tmp, &rmacfg)) != RT_ERR_OK)
        return retVal;
...
static rtk_api_ret_t _rtk_trap_lldpEnable_get(rtk_enable_t *pEnabled)
{
    ...
    if ((retVal = rtl8367c_getAsicRmaLldp((rtk_uint32*)pEnabled, &rmacfg)) != RT_ERR_OK)
        return retVal;
