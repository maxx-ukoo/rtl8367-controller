...
static rtk_api_ret_t _rtk_l2_flushLinkDownPortAddrEnable_get(rtk_port_t port, rtk_enable_t *pEnable)
{
    ...
    if ((retVal = rtl8367c_getAsicLutLinkDownForceAging((rtk_uint32*)pEnable)) != RT_ERR_OK)
        return retVal;
...
static rtk_api_ret_t _rtk_l2_agingEnable_get(rtk_port_t port, rtk_enable_t *pEnable)
{
    ...
    if ((retVal = rtl8367c_getAsicLutDisableAging(rtk_switch_port_L2P_get(port), (rtk_uint32*)pEnable)) != RT_ERR_OK)
        return retVal;
...
static rtk_api_ret_t _rtk_l2_localPktPermit_get(rtk_port_t port, rtk_enable_t *pPermit)
{
    ...
    if ((retVal = rtl8367c_getAsicPortBlockSpa(rtk_switch_port_L2P_get(port), (rtk_uint32*)pPermit)) != RT_ERR_OK)
        return retVal;
...
static rtk_api_ret_t _rtk_l2_ipMcastForwardRouterPort_get(rtk_enable_t *pEnabled)
{
    ...
    if ((retVal = rtl8367c_getAsicLutIpmcFwdRouterPort((rtk_uint32*)pEnabled)) != RT_ERR_OK)
        return retVal;
