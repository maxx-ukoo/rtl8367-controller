...
static rtk_api_ret_t _rtk_mirror_portIso_get(rtk_enable_t *pEnable)
{
    ...
    if ((retVal = rtl8367c_getAsicPortMirrorIsolation((rtk_uint32*)pEnable)) != RT_ERR_OK)
        return retVal;
...
static rtk_api_ret_t _rtk_mirror_vlanLeaky_get(rtk_enable_t *pTxenable, rtk_enable_t *pRxenable)
{
    ...
    if ((retVal = rtl8367c_getAsicPortMirrorVlanTxLeaky((rtk_uint32*)pTxenable)) != RT_ERR_OK)
        return retVal;

    if ((retVal = rtl8367c_getAsicPortMirrorVlanRxLeaky((rtk_uint32*)pRxenable)) != RT_ERR_OK)
        return retVal;
...
static rtk_api_ret_t _rtk_mirror_isolationLeaky_get(rtk_enable_t *pTxenable, rtk_enable_t *pRxenable)
{
    ...
    if ((retVal = rtl8367c_getAsicPortMirrorIsolationTxLeaky((rtk_uint32*)pTxenable)) != RT_ERR_OK)
        return retVal;

    if ((retVal = rtl8367c_getAsicPortMirrorIsolationRxLeaky((rtk_uint32*)pRxenable)) != RT_ERR_OK)
        return retVal;
...
static rtk_api_ret_t _rtk_mirror_keep_get(rtk_mirror_keep_t *pMode)
{
    ...
    if ((retVal = rtl8367c_getAsicPortMirrorRealKeep((rtk_uint32*)pMode)) != RT_ERR_OK)
        return retVal;
