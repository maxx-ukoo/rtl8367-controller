...
static rtk_api_ret_t _rtk_rldp_config_get(rtk_rldp_config_t *pConfig)
{
    ...
    if ((retVal = rtl8367c_getAsicRldp((rtk_uint32*)(&pConfig->rldp_enable))) != RT_ERR_OK)
        return retVal;

    if ((retVal = rtl8367c_getAsicRldpTriggerMode((rtk_uint32*)(&pConfig->trigger_mode))) != RT_ERR_OK)
        return retVal;
    ...
    if ((retVal = rtl8367c_getAsicRldpCompareRandomNumber((rtk_uint32*)(&pConfig->compare_type))) != RT_ERR_OK)
        return retVal;
