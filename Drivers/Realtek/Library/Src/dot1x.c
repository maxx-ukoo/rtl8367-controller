...
static rtk_api_ret_t _rtk_dot1x_unauthPacketOper_get(rtk_port_t port, rtk_dot1x_unauth_action_t *pUnauth_action)
{
    ...
    if ((retVal = rtl8367c_getAsic1xProcConfig(rtk_switch_port_L2P_get(port), (rtk_uint32*)pUnauth_action)) != RT_ERR_OK)
        return retVal;
...
static rtk_api_ret_t _rtk_dot1x_portBasedEnable_get(rtk_port_t port, rtk_enable_t *pEnable)
{
    ...
    if ((retVal = rtl8367c_getAsic1xPBEnConfig(rtk_switch_port_L2P_get(port), (rtk_uint32*)pEnable)) != RT_ERR_OK)
        return retVal;
...
static rtk_api_ret_t _rtk_dot1x_portBasedAuthStatus_get(rtk_port_t port, rtk_dot1x_auth_status_t *pPort_auth)
{
    ...
    if ((retVal = rtl8367c_getAsic1xPBAuthConfig(rtk_switch_port_L2P_get(port), (rtk_uint32*)pPort_auth)) != RT_ERR_OK)
        return retVal;
    return RT_ERR_OK;
}
...
static rtk_api_ret_t _rtk_dot1x_portBasedDirection_get(rtk_port_t port, rtk_dot1x_direction_t *pPort_direction)
{
    ...
    if ((retVal = rtl8367c_getAsic1xPBOpdirConfig(rtk_switch_port_L2P_get(port), (rtk_uint32*)pPort_direction)) != RT_ERR_OK)
        return retVal;
...
static rtk_api_ret_t _rtk_dot1x_macBasedEnable_get(rtk_port_t port, rtk_enable_t *pEnable)
{
    ...
    if ((retVal = rtl8367c_getAsic1xMBEnConfig(rtk_switch_port_L2P_get(port), (rtk_uint32*)pEnable)) != RT_ERR_OK)
        return retVal;
...
static rtk_api_ret_t _rtk_dot1x_macBasedDirection_get(rtk_dot1x_direction_t *pMac_direction)
{
    ...
    if ((retVal = rtl8367c_getAsic1xMBOpdirConfig((rtk_uint32*)pMac_direction)) != RT_ERR_OK)
        return retVal;
...
static rtk_api_ret_t _rtk_dot1x_guestVlan2Auth_get(rtk_enable_t *pEnable)
{
    ...
    if ((retVal = rtl8367c_getAsic1xGVOpdir((rtk_uint32*)pEnable)) != RT_ERR_OK)
        return retVal;
